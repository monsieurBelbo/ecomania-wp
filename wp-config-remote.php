...
define('DB_NAME', '240003_ecomania');

/** Tu nombre de usuario de MySQL */
define('DB_USER', '240003_ecomania');

/** Tu contraseña de MySQL */
define('DB_PASSWORD', 'ecomania');

/** Host de MySQL (es muy probable que no necesites cambiarlo) */
define('DB_HOST', 'pdb3.agilityhoster.com');
...
if ( !defined('ABSPATH') )
	define('ABSPATH', dirname(__FILE__) . '/v2');
