 ...
 * handled by a callback to newspress_comment which is
...
<?php if ( post_password_required() ) : ?>
				<p class="nopassword"><?php _e( 'This post is password protected. Enter the password to view any comments.', 'newspress' ); ?></p>
			</div><!-- #comments -->
<?php
...
<?php if ( have_comments() ) : ?>
			...
			<ol class="commentlist">
				<?php
					 ...
					 * to use newspress_comment() to format the comments.
					 * See newspress_comment() in newspress/functions.php for more.
					 */
					wp_list_comments( array( 'callback' => 'newspress_comment' ) );
				?>
			</ol>
...
<?php else : // or, if we don't have comments:
	...
	if ( ! comments_open() ) :
?>
	<p class="nocomments"><?php _e( 'Comments are closed.', 'newspress' ); ?></p>
<?php else: ?>
	<p class="nocomments"><?php _e( 'Still quiet here.', 'newspress' ); ?>sas</p>
